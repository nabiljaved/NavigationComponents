...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(toolbar) //this simple line will show toolbar

        val navHostFragment = supportFragmentManager
                .findFragmentById(R.id.nav_host_fragment) as NavHostFragment
        navController = navHostFragment.navController
        //drawer_layout will show hamburger icon
        appBarConfiguration = AppBarConfiguration(
                setOf(R.id.homeFragment,R.id.settingsFragment,R.id.notificationsFragment),
                drawer_layout
        )

        //it will not show up arrow from bottom navigation
...
//        toolbar.setupWithNavController(navController)
    ...
    //will show up button
    //Toggle Hamburger icon by passing appBarConfiguration
